...
import a6z.com.newmemo.Utils.PinYin2Abbreviation;
...
public class AccountItem implements Cloneable, Serializable, AccountChangedListener {
    ...
    private String alphabetOfTitle;
    private String id;
    ...
    public String getAlphabetOfTitle() {
        if (this.alphabetOfTitle == null) {
            this.alphabetOfTitle = PinYin2Abbreviation.cn2py(title);
        }
        return this.alphabetOfTitle;
    }
